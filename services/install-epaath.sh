...
function get_description {
  echo "E-Paath is a collection of digital interactive learning activities for grade 1 to 8 \"epaath\" "
}

# add info
function get_info {
  echo
  echo "E-Paath is a collection of digital interactive learning activities for grade 1 to 8"
}
